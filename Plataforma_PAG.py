# Arquivo: Plataforma_PAG.py (Versão Final e Estável com YAML)
...
try:
    ...
    st.error("Arquivo 'config.yaml' não encontrado. Certifique-se de que ele está na pasta principal do projeto.")
    st.stop()

# Inicializa o autenticador com as configurações do arquivo
